...
static void setup_gpmi_nand(void) { init_nand_clk(); }
#endif

#define LEC_IMX8MP_BOOT_IMAGE_GUID                                             \
  EFI_GUID(0x928b33bc, 0xe58b, 0x4247, 0x9f, 0x1d, 0x3b, 0xf1, 0xee, 0x1c,     \
           0xda, 0xff)

#if CONFIG_IS_ENABLED(EFI_HAVE_CAPSULE_SUPPORT)
struct efi_fw_image fw_images[] = {
    {
        .image_type_id = LEC_IMX8MP_BOOT_IMAGE_GUID,
        .fw_name = u"LEC-IMX8MP-RAW",
        .image_index = 1,
    },
};
...
static int setup_eqos(void) {
  ...
  clrsetbits_le32(&gpr->gpr[1], IOMUXC_GPR_GPR1_GPR_ENET_QOS_INTF_SEL_MASK,
                  BIT(16));
...
int board_init(void) {
  ...
  arm_smccc_smc(IMX_SIP_GPC, IMX_SIP_GPC_PM_DOMAIN, DISPMIX, true, 0, 0, 0, 0,
                &res);
  arm_smccc_smc(IMX_SIP_GPC, IMX_SIP_GPC_PM_DOMAIN, MIPI, true, 0, 0, 0, 0,
                &res);
...
int is_recovery_key_pressing(void) { return 0; /* TODO */ }
